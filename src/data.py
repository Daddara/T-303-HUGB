...
appointments = [Appointment(patients_list[0], [staff_members[0], staff_members[2]], [10, 8, 2022], "13:00", 60, 2, "Surgery on shoulder"), Appointment(patients_list[1], [staff_members[2]], [12, 9, 2022], "09:00", 30)]
