...
class HospitalsystemInterface:
  ...
  def send_presription (self, data):
    if "patient_id" in data  and "presription" in data :      
      #Here you call the actual operation in your backend code.
      return '{"msg":"Operation send_presription not yet implemented"}'
    else:
      return '{"msg":"Invalid request. The following parameters are required: patient_id,presription."}' 
